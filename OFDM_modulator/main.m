...
% Last Modified by GUIDE v2.5 24-May-2017 17:15:16
...
set(handles.editUsrpInterp,'String', paramsToRead{28})
set(handles.USRPSampleRate,'String', paramsToRead{29})
set(handles.oversamplingInput,'String', paramsToRead{30})
set(handles.editTxCycleCount,'String', paramsToRead{31})
set(handles.carrierFreqInput,'String', paramsToRead{32}) 
set(handles.txGain,'String', paramsToRead{33})
set(handles.USRPIPaddr,'String', paramsToRead{34}) 
%     gpib_addr  
%     sampleFreq 
set(handles.cyclicGeneration,'Value', str2num(paramsToRead{37}))
...
if (handles.langENG)
    handles.langENG = 0
    set(handles.dataInputGroup ,'Title','Vstupní data');
    set(handles.basicSettings ,'Title','Základní nastavení');
    set(handles.prefixRadioGroup ,'Title','Prefix/Ochranný interval');
    set(handles.subcarriersMapping ,'Title','Mapování subnosných a pilotních tón?');
    set(handles.packetPanel ,'Title','Nastavení paket?');
    set(handles.chanelParamsGroup ,'Title','Nastavení kanál?');
    set(handles.hintsPanel ,'Title','Nápov?da');
    set(handles.deviceSettingsPanel ,'Title','Nastavení výstupního za?ízení');
    set(handles.connectedDeviceGroup ,'Title','p?ipojené za?ízení');
    set(handles.noDeviceSettings ,'Title','Nastavení bez za?ízení');
    set(handles.usrpSettings ,'Title','USRP parametry');
    set(handles.lw410Params ,'Title','LW410 nastavení');
    set(handles.signalOutputPanel ,'Title','Výstupní signál');
    set(handles.dataInputRandomRadio ,'String','náhodná sekvence');
    set(handles.dataInputUserRadio ,'String','uživ. ?et?zec');
    set(handles.dataInputFileRadio ,'String','ze souboru');
    set(handles.modulationTypeText ,'String','Typ modulace dat');
    set(handles.numIFFTText ,'String','IFFT délka');
    set(handles.textSignalAmpl ,'String','Amplituda signálu');
    set(handles.symbolLengthLabel ,'String','Po?et symbolu');
    set(handles.intervalRadio ,'String','Cyklický prefix');
    set(handles.prefixLengthText ,'String','Délka prefixu');
    set(handles.guardRadio ,'String','Ochranný interval');
    set(handles.guardIntervalText ,'String','Ochranný int. [vlevo vpravo]');
    set(handles.intervalNotusedRadio ,'String','Nepoužít');
    set(handles.subcarrierMappingText ,'String','Mapování subnosných');
    set(handles.pilotPositionsText ,'String','Pozice pilotních tón?');
    set(handles.pilotAmplitudesText ,'String','Pilotní symboly amplituda');
    set(handles.packetHeadModText ,'String','Modulace hlavi?ek paket?');
    set(handles.packetLenText ,'String','Velikost paket? (byte)');
    set(handles.enablePackets ,'String','použít pakety');
    set(handles.sync1Text ,'String','1. synchroniza?ní slovo');
    set(handles.sync2Text ,'String','2. synchroniza?ní slovo');
    set(handles.renewSyncBut ,'String','generovat');
    set(handles.noChannelRadio ,'String','ideální p?enos');
    set(handles.cyclicGeneration ,'String','generovat cyklicky');
    set(handles.noDevice ,'String','bez za?ízení');
    set(handles.sampleRateText ,'String','Vzorkovací kmito?et (kHz)');
    set(handles.noDeviceOversamplingText ,'String','P?evzorkování');
    set(handles.oversampleText ,'String','P?evzorkování');
    set(handles.txCycleCountText ,'String','Po?et opakování');
    set(handles.txGainText ,'String','TX zisk');
    set(handles.gpibAddrLabel,'String','GPIB adresa');
    set(handles.sampleFreqLabel ,'String','Vzorkovací frekvence');
    set(handles.carrierFreqText ,'String','Vysílací kmito?et [kHz]');
else
    handles.langENG = 1;
